{% macro add_row_to_example_schools_table() -%}
    ...
    {% set query %}
        INSERT INTO STEVE_D_RAW_DATA.SAMPLE_SCHOOL_DATA.school_districts (District_ID, District_Name, School_Name, file_name, dbt_ready, file_processed, modifed_timestamp)
